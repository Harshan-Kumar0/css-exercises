...
This next exercise forin particular specificity and rule order. Both the HTML and CSS files are filled out for you, so instead of adding rules yourself, you will simply be editing what is provided.
 CSS Foundations is going to give you a closer look at the cascade, 
